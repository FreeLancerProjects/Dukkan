...
public class Fragment_Driver_Previous_Order extends Fragment {
    ...
    public static Fragment_Driver_Previous_Order newInstance()
    {
        return new Fragment_Driver_Previous_Order();
    }
