...
public class OrderItem implements Serializable
{
    ...
    public OrderItem(String product_image, String product_id, String feature_id, String product_price_id, String product_name_ar, String product_name_en, String product_size_ar, String product_size_en, int product_quantity, double product_price, double product_total_price) {
