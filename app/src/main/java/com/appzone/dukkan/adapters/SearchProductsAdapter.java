...
public class SearchProductsAdapter extends RecyclerView.Adapter{
    ...
    private SearchProductsAdapter.LoadMoreListener loadMoreListener;
    private MainCategory.Products products;


    public SearchProductsAdapter(Context context, List<MainCategory.Products> productsList, Fragment_Search fragment_search, final RecyclerView recView) {
        ...
        if (holder instanceof MyHolder)
        {
            ...
            myHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    products = productsList.get(holder.getAdapterPosition());

                    if (products!=null)
                    {
                        fragment_search.setItemForDetails(products);
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View itemView) {
            super(itemView);
            ll_discount_container = itemView.findViewById(R.id.ll_discount_container);
        ...
        public void BindData(MainCategory.Products products)
        {
            ...
            if (products.getFeatures().size()>0)
            {
                ...
                try {
                    ...
                    ll_discount_container.setVisibility(View.VISIBLE);
            ...
            }else
                {
                    ...
                    ll_discount_container.setVisibility(View.GONE);
